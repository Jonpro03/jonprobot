showHelpModal = function (articleName) {
  ...
  switch (articleName) {
    case "estimates":
      ...
      <img src="site-images/estimates.png?a=217" class="card-img-top" alt="estimates chart">
      ...
      <div class="ratio ratio-4x3">
        <video autoplay playsinline webkit-playsinline loop class="embed-responsive-item" src="site-images/estimates.mp4?a=217" type="video/mp4"></video>
      </div>
      </p>
      <p>
    ...
    case "shares":
      ...
      <img src="site-images/shares.png?a=217" class="card-img-top" alt="shares chart">
      <strong>X-Axis:</strong> Date
      </br>
      ...
      <img src="site-images/shares2.png?a=217" class="card-img-top" alt="shares chart">
      </p>
      <p>
      This chart is zoomed in to fit your device's screen. Zoom with mousewheel or pinching. Scroll by dragging left or right.
      </p>
    ...
    case "highscores":
      ...
      This chart illustrates data collected from the Reddit Sample Set. Keep in mind that this only shows
      data that has been sampled from Reddit, and does not represent all Computershare Accounts.
      <img src="site-images/highscores.png?a=217" class="card-img-top" alt="highscores chart">
      <strong>X-Axis:</strong> Date
      </br>
    ...
    case "statistics":
      ...
      <img src="site-images/stats.png?a=217" class="card-img-top" alt="statistics chart">
      <strong>X-Axis:</strong> Date
      </br>
      <strong>Y-Axis:</strong> Share Count
      </p>
    ...
    case "distribution":
      ...
      <img src="site-images/distribution.png?a=217" class="card-img-top" alt="histogram chart">
      ...
      <img src="site-images/distribution2.png?a=217" class="card-img-top" alt="histogram chart">
      </p>
      `;
      break;
    ...
    case "growth":
      ...
      <img src="site-images/growth.png?a=217" class="card-img-top" alt="growth chart">
    ...
    case "power":
      ...
      <img src="site-images/power.png?a=217" class="card-img-top" alt="purchase power chart">
      <strong>X-Axis:</strong> Week Beginning Date
      </br>
    ...
    case "calculator":
      ...
      <div class="ratio ratio-4x3">
        <video autoplay playsinline webkit-playsinline loop class="embed-responsive-item" src="site-images/metric.mp4?a=217" type="video/mp4"></video>
      </div>
      ...
      <div class="ratio ratio-4x3">
        <video autoplay playsinline webkit-playsinline loop class="embed-responsive-item" src="site-images/calculator.mp4?a=217" type="video/mp4"></video>
      </div>
      ...
      <div class="ratio ratio-4x3">
        <video autoplay playsinline webkit-playsinline loop class="embed-responsive-item" src="site-images/calculator3.mp4?a=217" type="video/mp4"></video>
      </div>
      </p>
      <p>
      Another useful comparison is retail to remaining...
      <div class="ratio ratio-4x3">
        <video autoplay playsinline webkit-playsinline loop class="embed-responsive-item" src="site-images/calculator2.mp4?a=217" type="video/mp4"></video>
      </div>
      </p>
      `;
      break;
